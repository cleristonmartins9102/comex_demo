...
@Component({
  selector: 'app-lista-liberacao',
  templateUrl: './lista-liberacao.component.html',
  styleUrls: ['./lista-liberacao.component.css'],
})

export class ListaLiberacaoComponent {
  email: any;
  data: any = {
    menu: '',
  ...
  constructor(
    ...
    const menu = new Menu('liberacao', 'liberacao', 'lista de liberações');
