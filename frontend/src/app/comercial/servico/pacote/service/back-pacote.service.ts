...
export class PacoteService {
    ...
    save(formulario: FormGroup) {
      return this.http.post(`${this.bk_full_address}/pacote/save/store`, JSON.stringify(formulario.value));
    }
    ...
    getById(id: string) {
      ...
      return this.http.post(`${this.bk_full_address}/pacote/lista/byid`, id_pacote);
    }
}
